...
class RedDawn extends Component {
    ...
    this.state ={
      ...
      missionTodos: [
        ...
        {id: 9, content: 'Run quickly to the river that runs outside the palace, a wasen(boat) with royal guards will be waiting for the princess'},               
      ]
    }
  }
  addTodo = (todo) =>{
  ...
  render() {
    return (
        ...
        <div className="mission">
          <div id='mission'></div>
          <h2 className="center">Red Dawn</h2>
